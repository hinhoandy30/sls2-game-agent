...
本仓库基于上游开源 `STS2 AI Agent` 项目继续开发，目标是在《Slay the Spire 2》上构建专用游戏 agent。当前仓库包含：
...
本项目不是从零原创项目。当前代码基础来自上游开源 `STS2 AI Agent` 项目；本团队在此基础上做版本适配、团队协作规范和专用 agent runner 开发。

当前本地源码包没有保留原始 upstream remote URL。项目 owner 在公开发布前需要补充准确的原始 GitHub 链接，并继续保留现有 AGPL-3.0-only 许可证说明。
