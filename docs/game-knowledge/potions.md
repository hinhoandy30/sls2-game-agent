...
Potion rarity, usage timing, and targeting metadata for future potion support.

| Name | Rarity | Usage | Target |
| --- | --- | --- | --- |
...
| DeprecatedPotion | None | CombatOnly | AnyEnemy |
...
| FoulPotion | Event | AnyTime | TargetedNoCreature |
